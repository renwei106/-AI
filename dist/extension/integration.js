...
(function () {
  ...
  document.addEventListener('click',event=>{if(!event.target.closest('#space-atlas [data-at-header="inbox"]'))return;event.preventDefault();signed?openLaterDrawer():show('#login')},true);
