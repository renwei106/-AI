module.exports=async function themeConfigProxy(req,res){
  ...
  if(!['/api/shiyu/themes','/api/shiyu/plans','/api/shiyu/plans/catalog','/api/shiyu/operations','/api/shiyu/agreements','/api/shiyu/member-visual','/api/shiyu/i18n/public'].includes(url.pathname)||req.method!=='GET')return false
  try{
